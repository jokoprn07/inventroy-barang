...
$sql = mysqli_query($conn, "SELECT * FROM karton WHERE id = '$id'");
      ...
      <table class="table table-striped table-bordered">
        ...
        <tr>
					...
					<tr>
						...
						<td style=min-width:50px> : '.$data['code_barang'].'</td>
					...
					<tr>
						...
						<td style=min-width:50px> : '.$data['code_customer'].'</td>
					...
					$text .='<tr>
						...
						<td style=min-width:50px>'.$data['size_barang'].'</td>
					...
					<tr>
						...
						<td style="min-width:50px;" class="text-center">Rp. </td>
					</tr>
					<tr>
						<td style=min-width:50px></td>
						<td style=min-width:50px></td>
						...
						<td style=min-width:50px></td>
						<td style=min-width:50px></td>
						<td class="text-center">Rp. hasil</td>
                    </tr>';
					}
					$text .='<tr>
