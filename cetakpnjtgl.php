...
if(isset($_POST['tanggal'])){
    ...
    $sql = mysqli_query($conn, "SELECT * FROM d_penjualan WHERE tanggal_penjualan BETWEEN '$tglawal' AND '$tglakhir' ");
...
<div class="table-responsive" style="margin-top: 20px;">
      <table class="table table-striped table-bordered">
        <thead>
			...
			$query = mysqli_query($conn, "SELECT SUM(total_penjualan) AS total FROM dp_barang WHERE tanggal_pembelian BETWEEN '$tglawal' AND '$tglakhir' ");
