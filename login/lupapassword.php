...
<html lang="en">
  <head>
    ...
    <title>Inventory Barang | Lupa Password</title>
  </head>
  <body>
  <div class="container">
  <div class="card mt-3">
    <div class="card-header text-center">
      Inventory Barang | Lupa Password
    </div>
    <div class="card-body">
      ...
      <button type="submit" name="submit" class="form-control btn btn-primary">Send Code</button><br><br>
