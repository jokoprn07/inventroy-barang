...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cogs-user"></i> Data Admin</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="container table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php $i = 1; ?>
            ...
            <td class="text-center"><a href="editadmin.php?id=<?= $adm['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Edit</button></a> | 
            <a href="hapusadmin.php?id=<?= $adm['id']; ?>" onclick="return confirm('Apakah Anda Yaking Ingin Menghapus Admin Ini?')"><button class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button></a> | 
            <a href="ubahpassword.php?id=<?= $adm['id']; ?>"><button class="btn btn-success"><i class="fas fa-unlock-alt"></i> Ubah Password</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
