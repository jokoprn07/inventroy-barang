...
$data = query("SELECT * FROM d_penjualan WHERE id = $id")[0];
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Ubah Data Penjualan</h3>
            <hr>
        </div>
      </div>
               ...
               <input type="hidden" name="tanggal_penjualan" value="<?= $data['tanggal_penjualan']; ?>">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="satuan" id="satuan" class="form-control">
                        ...
                        <option value="PCS" <?= $data['satuan'] == "PCS" ? "selected" : null ?>>PCS</option>
                        <option value="SET" <?= $data['satuan'] == "SET" ? "selected" : null ?>>SET</option>
                        <option value="KG" <?= $data['satuan'] == "KG" ? "selected" : null ?>>KG</option>
                        <option value="LITER" <?= $data['satuan'] == "LITER" ? "selected" : null ?>>LITER</option>
                        <option value="ROLL" <?= $data['satuan'] == "ROLL" ? "selected" : null ?>>ROLL</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
