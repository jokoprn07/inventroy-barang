...
$jumlahData = count(query("SELECT * FROM karton"));
...
$barang = mysqli_query($conn, "SELECT id, nama_item, SUM(qty) AS stock, SUM( `total_top` + `total_leg` + `total_cross` ) AS total FROM karton GROUP BY nama_item ASC LIMIT $awalData, $jumlahDataPerHalaman");
...
<nav class="navbar-default navbar-side" role="navigation">
        ...
        <ul class="nav" id="main-menu">
          ...
          <li>
            ...
            <ul class="nav nav-second-level">
              ...
              <li>
                <a href="datapembeliankaton.php"><i class="fa fa-database"></i> Data Pembelian Karton</a>
              </li>
              <li>
    ...
    <div id="page-wrapper">
      ...
      <a href="tambahkarton.php"><button class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah Data</button></a>

      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Data Karton</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        <thead>
            ...
            <th class="text-center" scope="col" rowspan="2"  style="vertical-align: middle;">Total</th>
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><?= $data['stock']; ?></td>
            <td><a href="editkarton.php?id=<?= $data['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Edit</button></a>

            <a href="hapuskarton.php?id=<?= $data['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?');"><button class="btn btn-danger" onclick="hapusBarang()"><i class="fas fa-trash"></i> Hapus</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
