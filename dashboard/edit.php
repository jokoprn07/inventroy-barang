        ...
        <div class="row">
            ...
            <input type="hidden" name="id" id="id" value="<?= $barang['id']; ?>">
                <div class="form-group">
                    ...
                    <input type="text" id="kode" name="kode_barang" class="form-control" value="<?= $barang['kode_barang']; ?>" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="first_stock" id="first_stock" class="form-control" value="<?= $barang['first_stock']; ?>" >
                </div>
