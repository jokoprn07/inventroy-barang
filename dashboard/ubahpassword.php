...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Ubah Password</h3>
            <hr>
        </div>
      </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="id" id="id" value="<?= $admin['id']; ?>" >
                <div class="form-group">
                    ...
                    <input type="password" name="newpassword" id="newpassword" class="form-control" placeholder="Masukkan Password Baru Anda" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="confirmpassword">Confirm Password :</label>
                    <input type="password" name="confirmpassword" id="confirmpassword" class="form-control" placeholder="Konfirmasi Password Baru Anda" autocomplete="off">
                </div>
