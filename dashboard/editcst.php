...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Ubah Data Customer</h3>
            <hr>
        </div>
      </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="kode" name="kode_customer" class="form-control" placeholder="Masukkan Kode Customer" autocomplete="off" value="<?= $customer['kode_customer'] ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="item">Nama Customer :</label>
                <input type="text" id="item" name="nama_customer" class="form-control" placeholder="Masukkan Nama Customer" autocomplete="off" value="<?= $customer['nama_customer'] ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="alamat">Alamat Customer :</label>
                <input type="text" id="alamat" name="alamat_customer" class="form-control" placeholder="Masukkan Alamat Customer" autocomplete="off" value="<?= $customer['alamat_customer'] ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="jenis">Jenis :</label>
                <input type="text" id="jenis" name="jenis" class="form-control" placeholder="Masukkan Jenis" autocomplete="off" value="<?= $customer['jenis'] ?>">
            </div>
