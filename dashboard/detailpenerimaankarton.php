    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        <thead>
            ...
            <th class="text-center" scope="col" rowspan="2"  style="vertical-align: middle;">Jumlah Terima</th>
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><a href="editpenerimaankarton.php?id=<?= $data['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Proses</button></a>
            <a href="hapuspenerimaankarton.php?id=<?= $data['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?');"><button class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button></a>
