...
if( isset($_POST['submit']) ){
  if( tmbsupp($_POST) > 0 ){
    echo "<script>alert('Data Suplier Berhasil Ditambahkan');
    window.location.href = 'suplier.php';
    </script>";
  }else{
    echo "<script>alert('Data Suplier Gagal Ditambahkan')</script>";
  }
}
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Tambah Data Suplier</h3>
            <hr>
        </div>
      </div>
        ...
        <div class="row">
            ...
            <form action="" method="post">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="kode" name="kode_suplier" class="form-control" placeholder="Masukkan Kode Suplier" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="item">Nama Suplier :</label>
                    <input type="text" id="item" name="nama_suplier" class="form-control" placeholder="Masukkan Nama Suplier" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="alamat">Alamat Suplier :</label>
                    <input type="text" id="alamat" name="alamat_suplier" class="form-control" placeholder="Masukkan Alamat Suplier" autocomplete="off">
                </div>
