...
$barang = mysqli_query($conn, "SELECT * FROM customer ORDER BY kode_customer ASC LIMIT $awalData, $jumlahDataPerHalaman");

if( isset($_POST['search']) ){
  $barang = caricst(mysqli_real_escape_string($conn, $_POST['keyword']));
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Data Customer</h3>
            <hr>
        </div>
      </div>
    ...
    <br>
    <a href="tmbcst.php"><button type="submit" name="submit" class="btn btn-success">Tambah Data Customer</button></a>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><?= $data['jenis']; ?></td>
            <td><a href="editcst.php?id=<?= $data['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Edit</button></a> | 
            <a href="hapuscst.php?id=<?= $data['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?');"><button class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
