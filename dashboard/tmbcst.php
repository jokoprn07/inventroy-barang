...
if( isset($_POST['submit']) ){
  if( tmbcst($_POST) > 0 ){
    echo "<script>
    window.location.href = 'tmbcst.php';
    </script>";
  }else{
    echo "<script>alert('Data Customer Gagal Ditambahkan')</script>";
  }
}
        ...
        <div class="row">
            ...
            <form action="" method="post">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="kode" name="kode_customer" class="form-control" placeholder="Masukkan Kode Customer" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="item">Nama Customer :</label>
                    <input type="text" id="item" name="nama_customer" class="form-control" placeholder="Masukkan Nama Customer" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="alamat">Alamat Customer :</label>
                    <input type="text" id="alamat" name="alamat_customer" class="form-control" placeholder="Masukkan Alamat Customer" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="jenis">Jenis :</label>
                    <input type="text" id="jenis" name="jenis" class="form-control" placeholder="Masukkan Jenis" autocomplete="off">
                </div>
