...
$jumlahData = count(query("SELECT * FROM dk_penjualan"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET['halaman']) ) ? $_GET['halaman'] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;

$barang = mysqli_query($conn, "SELECT * FROM dk_penjualan GROUP BY kode_penjualan ASC LIMIT $awalData, $jumlahDataPerHalaman");

if( isset($_POST['search']) ){
  $barang = cariPenjualan(mysqli_real_escape_string($conn, $_POST['keyword']));
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Data Penjualan Non Karton</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><a href="detailpenjualankarton.php?id=<?= $data['kode_penjualan']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Detail</button></a> | 
            <a href="../cetakpenjualankarton.php?id=<?= $data['kode_penjualan']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-print"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
