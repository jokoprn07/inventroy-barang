...
$barangs = mysqli_query($conn, "SELECT * FROM dp_barang ORDER BY kode_pembelian ASC LIMIT $startData, $pageData");
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-boxes"></i> Barang Jadi</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barangs as $data) :
            $status = $data['jumlah_pembelian'] - $data['jumlah_terima'];
          ...
          ?>
            ...
            <td><?= $data['jumlah_pembelian'] != $data['jumlah_terima'] ? "Masih Kurang $status" : "Sudah Diterima Semua" ?></td>
            <td><a href="../cetakbarangjadi.php?id=<?= $data['id']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-print"></i> Cetak</button></a>
