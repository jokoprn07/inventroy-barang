...
$barang = mysqli_query($conn, "SELECT * FROM `d_penjualan` WHERE kode_penjualan = '$kode' ");
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><a href="editpenjualan.php?id=<?= $data['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Edit</button></a>
            <a href="hapuspembelian.php?id=<?= $data['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?');"><button class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
