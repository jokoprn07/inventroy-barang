...
$barang = mysqli_query($conn, "SELECT * FROM dp_barang GROUP BY kode_pembelian ASC LIMIT $awalData, $jumlahDataPerHalaman");
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Data Pembelian Non Karton</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td scope="row"><?= rupiah($data['harga_beli']); ?></td>
            <td scope="row"><?= rupiah($data['total_pembelian']); ?></td>
            
            <td>
            <a href="detailpembelian.php?kode_pembelian=<?= $data['kode_pembelian']; ?>" ><button class="btn btn-success"><i class="fas fa-info"></i> Detail</button></a> | 
             <a href="../cetakpembelian.php?kode_pembelian=<?= $data['kode_pembelian']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-info"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
