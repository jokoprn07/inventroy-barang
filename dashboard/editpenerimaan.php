...
$barang = query( "SELECT * FROM dp_barang WHERE id = $id")[0];

if( isset($_POST['submit']) ){
  if( editPenerimaan($_POST) > 0 ){
    echo "<script>alert('Data Berhasil Diubah');
    window.location.href = 'detailpenerimaan.php';
    </script>";
  }else{
        ...
        <div class="row">
            ...
            <input type="hidden" name="id" id="id" value="<?= $barang['id']; ?>" >
                <div class="form-group col-md-6">
                    ...
                    <select name="kode_pembelian" id="no_po" data-live-search="true" class="form-control selectpicker">
                      <option value="">-- Pilih No PO --</option>
                      
                      <?php $data = mysqli_query($conn, "SELECT kode_pembelian FROM dp_barang"); ?>
                      <?php foreach( $data as $db): ?>
                      
                      <option value="<?= $db['kode_pembelian']; ?>" <?= $db['kode_pembelian'] == $db['kode_pembelian'] ? "selected" : null ?> > <?= $db['kode_pembelian'] ?> </option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="jumlah_pembelian" id="qty" class="form-control" placeholder="Masukkan Quantity" autocomplete="off" value="<?= $barang['jumlah_pembelian']; ?>">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" id="tanggal_terima" name="tanggal_terima" class="form-control" data-date-format="DD/MMM/YYYY" placeholder="dd/mm/yyyy" autocomplete="off" value="<?= $barang['tanggal_pembelian']; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="tanggal_expired">Tanggal Expired :</label>
                    <input type="date" id="tanggal_expired" name="tanggal_expired" class="form-control" data-date-format="DD/MMM/YYYY" placeholder="dd/mm/yyyy" autocomplete="off" value="<?= $barang['jangka_waktu']; ?>">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="divisi" name="divisi" class="form-control" placeholder="Masukkan Divisi" autocomplete="off" value="<?= $barang['divisi']; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="ppn">PPN :</label>
                    <input type="text" id="ppn" name="ppn" class="form-control" placeholder="Masukkan PPN" autocomplete="off" value="<?= $barang['ppn']; ?> ">
                </div>
                <div class="form-group col-md-6">   
                    <label for="keterangan">Keterangan :</label>
                    <textarea name="keterangan" id="keterangan" class="form-control" cols="20" rows="3"><?= $barang['keterangan']; ?></textarea>
                </div>
                
                <button type="submit" name="submit" class="btn btn-primary form-control">Proses Data</button>
            </form>
            </div>
        </div>
