...
$barang = mysqli_query($conn, "SELECT * FROM karton ORDER BY nama_item ASC");
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Laporan Karton</h3>
            <hr>
        </div>
      </div>

    <form class="form-inline " action="" method="post">
      <input class="form-control" type="text" name="keyword" id="keyword" placeholder="Cari Berdasarkan Nama Item, Code Customer & Nama Customer" size="50" autocomplete="on">
    ...
    <table class="table table-striped table-bordered">
        <thead>
            ...
            <th class="text-center" scope="col" rowspan="2" style="vertical-align: middle;">Nama Customer</th>
            <th class="text-center" scope="col" rowspan="2" style="vertical-align: middle;">Code Customer</th>
            <th class="text-center" scope="col" rowspan="2"  style="vertical-align: middle;">Size Barang</th>
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><?= $data['size_barang']; ?></td>
            <td><a href="../cetakkarton.php?id=<?= $data['id']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-print"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
