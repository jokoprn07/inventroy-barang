...
$jumlahData = count(query("SELECT * FROM d_penjualan"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET['halaman']) ) ? $_GET['halaman'] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;

$barang = mysqli_query($conn, "SELECT * FROM d_penjualan GROUP BY kode_penjualan ASC LIMIT $awalData, $jumlahDataPerHalaman");
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td><a href="detailpenjualan.php?id=<?= $data['kode_penjualan']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Detail</button></a> | 
            <a href="../cetakpenjualan.php?id=<?= $data['kode_penjualan']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-print"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
