...
$barang = mysqli_query($conn, "SELECT * FROM perusahaan");
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Nama Perusahaan</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        <thead>
            ...
            <th class="text-center" scope="col">Alamat Perusahaan</th>
            <th class="text-center" scope="col">Pemilik Perusahaan</th>
            <th class="text-center" scope="col">Kota Perusahaan</th>
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td> <?= $data['pemilik']; ?></td>
            <td> <?= $data['kota_perusahaan']; ?></td>
            <td><a href="editperusahaan.php?id=<?= $data['id']; ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> Edit</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
