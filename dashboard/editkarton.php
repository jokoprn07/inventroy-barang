...
$barang = query( "SELECT * FROM karton WHERE id = $id")[0];

if( isset($_POST['submit']) ){
  if( editKarton($_POST) > 0 ){
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Ubah Data Stock Barang</h3>
            <hr>
        </div>
      </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="id" id="id" value="<?= $barang['id']; ?>" >
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="nama_item" id="item" class="form-control" value="<?= $barang['nama_item']; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="nama_customer">Nama Customer :</label>
                    <input type="text" name="nama_customer" id="nama_customer" class="form-control" value="<?= $barang['nama_customer']; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="size_barang">Size Barang :</label>
                    <input type="text" name="size_barang" id="size_barang" class="form-control" value="<?= $barang['size_barang']; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="kode_customer">Kode Customer :</label>
                    <input type="text" id="kode_customer" name="kode_customer" class="form-control" value="<?= $barang['code_customer']; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="kode_produk">Kode Produk :</label>
                    <input type="text" id="kode_produk" name="kode_produk" class="form-control" value="<?= $barang['code_barang']; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="top">Size Box - Top :</label>
                    <input type="text" name="top" id="top" class="form-control" value="<?= $barang['top_karton']; ?>" >
                </div>
                <div class="form-group col-md-6">
                    <label for="leg">Size Box - Leg :</label>
                    <input type="text" name="leg" id="leg" class="form-control" value="<?= $barang['leg']; ?>" >
                </div>
                <div class="form-group col-md-6">
                    <label for="cross">Size Box - Cross :</label>
                    <input type="text" name="cross_karton" id="cross" class="form-control" value="<?= $barang['cross_karton']; ?>" >
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" name="harga_top" id="topharga" class="form-control" value="<?= $barang['harga_top']; ?>" >
                </div>
                <div class="form-group col-md-6">
                    <label for="legharga">Leg - Harga :</label>
                    <input type="number" name="harga_leg" id="legharga" class="form-control" value="<?= $barang['harga_leg']; ?>" >
                </div>
                <div class="form-group col-md-6">
                    <label for="crossharga">Cross - Harga :</label>
                    <input type="number" name="harga_cross" id="crossharga" class="form-control" value="<?= $barang['harga_cross']; ?>" >
                </div>
                <div class="form-group col-md-6">
                    <label for="keterangan">Keterangan :</label>
                     <textarea name="keterangan" id="keterangan" required class="form-control" cols="10" rows="5"><?= $barang['keterangan']; ?></textarea>
                </div>
