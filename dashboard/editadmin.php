...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-plus-square"></i> Ubah Data Admin</h3>
            <hr>
        </div>
      </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="id" id="id" value="<?= $admin['id']; ?>" >
                <div class="form-group">
                    ...
                    <input id="username" name="username" class="form-control" value="<?= $admin['username']; ?>" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="email">Email :</label>
                    <input type="email" name="email" id="email" class="form-control" value="<?= $admin['email']; ?>" autocomplete="off">
                </div>
