...
$barang = mysqli_query($conn, "SELECT * FROM d_penjualan ORDER BY nama_barang ASC");
...
<nav class="navbar-default navbar-side" role="navigation">
    ...
    <div id="page-wrapper">
      ...
      <a href="tambahpenjualan.php"><button class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah Data</button></a>

      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Laporan Penjualan</h3>
            <hr>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="../cetakpnjtgl.php" method="post" target="_blank">
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td class="text-center"><?= $data['jumlah_item']; ?></td>
            <td class="text-center"><?= $data['tanggal_penjualan']; ?></td>
            <td class="text-center"><?= $data['keterangan']; ?></td>
            <td><a href="../cetakpenjualan.php?id=<?= $data['id']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-print"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
