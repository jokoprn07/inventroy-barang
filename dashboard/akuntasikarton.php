...
$barang = mysqli_query($conn, "SELECT nama_suplier, kode_suplier, size, tanggal_pembelian, jangka_waktu, no_po, nama_item, jumlah_terima,qty, (t_total + l_total + c_total ) AS harga, keterangan FROM dp_karton GROUP BY no_po LIMIT $awalData, $jumlahDataPerHalaman");
...
<nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
            <a href="penerimaan.php"><i class="fas fa-boxes"></i> Penerimaan Barang</a>
          </li>
          <li>
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-12">
            <h3 style="margin-left: 20px;"><i class="fas fa-cube"></i> Data Akuntasi Non Karton</h3>
            <hr>
        </div>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
        ...
        <?php foreach($barang as $data) : ?>
            ...
            <td scope="row"><?= $data['nama_suplier']; ?></td>
            ...
            <td>
            <a href="detailakuntasikarton.php?no_po=<?= $data['no_po']; ?>" ><button class="btn btn-success"><i class="fas fa-info"></i> Detail</button></a> | 
             <a href="../cetakakuntasikarton.php?no_po=<?= $data['no_po']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-info"></i> Cetak</button></a>
            </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
