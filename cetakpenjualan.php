...
$sql = mysqli_query($conn, "SELECT * FROM d_penjualan WHERE kode_penjualan = '$id'");
...
<div class="table-responsive" style="margin-top: 20px;">
      <table class="table table-striped table-bordered">
        ...
        <tr>
					...
					<tr>
						<td colspan="6" class="text-center">Penjualan</td>
					</tr>
					<tr>
						<td style=min-width:50px></td>
						<td style=min-width:50px></td>
					...
					$sql = mysqli_query($conn, "SELECT SUM(total_penjualan) AS total FROM d_penjualan WHERE kode_penjualan = '$id'");
$data = mysqli_fetch_assoc($sql);
					...
					<tr>
						<td style=min-width:50px></td>
						<td style=min-width:50px></td>
						<td colspan="4" style="min-width:50px">Total</td>
						<td class="text-center">'.rupiah($data['total']).'</td>
					</tr>';

					$sql = mysqli_query($conn, "SELECT keterangan FROM d_penjualan WHERE kode_penjualan = '$id'");
$data = mysqli_fetch_assoc($sql);
